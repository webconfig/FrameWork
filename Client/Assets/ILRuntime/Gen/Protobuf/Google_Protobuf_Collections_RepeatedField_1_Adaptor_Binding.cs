...
{
    unsafe class Google_Protobuf_Collections_RepeatedField_1_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor>);
            args = new Type[]{typeof(Google.Protobuf.CodedOutputStream), typeof(Google.Protobuf.FieldCodec<Adapt_IMessage.Adaptor>)};
            method = type.GetMethod("WriteTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteTo_0);
            args = new Type[]{typeof(Google.Protobuf.FieldCodec<Adapt_IMessage.Adaptor>)};
            method = type.GetMethod("CalculateSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CalculateSize_1);
            args = new Type[]{typeof(Google.Protobuf.CodedInputStream), typeof(Google.Protobuf.FieldCodec<Adapt_IMessage.Adaptor>)};
        ...
        static StackObject* WriteTo_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.FieldCodec<Adapt_IMessage.Adaptor> codec = (Google.Protobuf.FieldCodec<Adapt_IMessage.Adaptor>)typeof(Google.Protobuf.FieldCodec<Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor> instance_of_this_method;
            instance_of_this_method = (Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor>)typeof(Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* AddRange_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<Adapt_IMessage.Adaptor> values = (System.Collections.Generic.IEnumerable<Adapt_IMessage.Adaptor>)typeof(System.Collections.Generic.IEnumerable<Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor> instance_of_this_method;
            instance_of_this_method = (Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor>)typeof(Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.Protobuf.Collections.RepeatedField<Adapt_IMessage.Adaptor>();
