...
{
    unsafe class Google_Protobuf_MessageParser_1_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Google.Protobuf.MessageParser<Adapt_IMessage.Adaptor>);
        ...
        static StackObject* ParseFrom_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.MessageParser<Adapt_IMessage.Adaptor> instance_of_this_method;
            instance_of_this_method = (Google.Protobuf.MessageParser<Adapt_IMessage.Adaptor>)typeof(Google.Protobuf.MessageParser<Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
