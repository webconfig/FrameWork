...
{
    unsafe class AssetbundleLoader_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(AssetbundleLoader);
            args = new Type[]{typeof(System.String), typeof(System.String), typeof(System.String)};
            method = type.GetMethod("InstantiateGameObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, InstantiateGameObject_0);
