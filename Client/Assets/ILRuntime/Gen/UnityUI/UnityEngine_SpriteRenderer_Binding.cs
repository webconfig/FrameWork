...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_SpriteRenderer_Binding
    {
        ...
        static StackObject* get_sprite_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.SpriteRenderer instance_of_this_method;
            instance_of_this_method = (UnityEngine.SpriteRenderer)typeof(UnityEngine.SpriteRenderer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
